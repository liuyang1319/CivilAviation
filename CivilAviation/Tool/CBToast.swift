...
class CBToast: NSObject {
    ...
    static var defaultShowTime = 3.0
    ...
    //默认显示消息-->center
    @objc class func showToastAction(message : NSString) {
        self.showToast(message: message, aLocationStr: "center", aShowTime: defaultShowTime)
    }
    ...
    class func showIndicatorToastAction(message : NSString) {
        self.showIndicatorToast(message: message, aLocationStr: "center", aShowTime: defaultShowTime)
    }
